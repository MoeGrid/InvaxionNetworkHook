...
namespace InvaxionNetworkHook.Hook
{
    class HookManager
    {
        ...
        public void Create()
        {
            ...
            // 修改配置文件
            var GlobalConfigInit = AccessTools.Method(typeof(GlobalConfig), "init");
            var GlobalConfigInitPostfix = AccessTools.Method(typeof(HookGlobalConfig), "InitPostfix");
            instance.Patch(GlobalConfigInit, null, new HarmonyMethod(GlobalConfigInitPostfix));
